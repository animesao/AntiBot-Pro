...
public class AntiBotCommand implements SimpleCommand {
        ...
        switch (args[0].toLowerCase()) {
            case "reload":
                ...
                invocation
                    ...
                    .sendMessage(
                        Component.text(
                            "Конфигурация AntiBot перезагружена!"
            ...
            case "unblock":
                if (args.length < 2) {
                    invocation
                        ...
                        .sendMessage(
                            Component.text(
                                "Использование: /antibot unblock <ip>"
                            ).color(NamedTextColor.RED)
                        );
                    return;
                }
            ...
            case "linked":
                if (args.length < 2) {
                    invocation
                        ...
                        .sendMessage(
                            Component.text(
                                "Использование: /antibot linked <player/discord> <value>"
                            ).color(NamedTextColor.RED)
                        );
                    return;
                }
                handleLinked(invocation, args);
                break;
            case "discord":
                handleDiscord(invocation, args);
                break;
            case "accounts":
                sendAccountsStats(invocation);
                break;
            case "behavior":
                if (args.length < 2) {
            ...
            case "check":
                if (args.length < 2) {
                    invocation
                        ...
                        .sendMessage(
                            Component.text(
                                "Использование: /antibot check <player/ip>"
                            ).color(NamedTextColor.RED)
                        );
                    return;
                }
    ...
    private void sendHelp(Invocation invocation) {
        ...
        sendCommandHelp(
            invocation,
            "/antibot whitelist <add/remove> <ip/player> <value>",
            "Управление вайтлистом"
        );
        sendCommandHelp(
            invocation,
            "/antibot behavior [player]",
            "Анализ поведения"
        );
        sendCommandHelp(
            invocation,
            "/antibot check <player/ip>",
            "Проверить игрока/IP"
        );
        sendCommandHelp(
            invocation,
            "/antibot linked <player/discord> <value>",
            "Проверить привязку аккаунтов"
        );
        sendCommandHelp(
            invocation,
            "/antibot discord <status/reload>",
            "Управление Discord ботом"
        );
        sendCommandHelp(
            invocation,
            "/antibot accounts",
            "Статистика привязанных аккаунтов"
        );
    ...
    private void sendStatus(Invocation invocation) {
        ...
        invocation
            ...
            .sendMessage(
                Component.text("Режим атаки: ")
                    ...
                    .append(
                        Component.text(
                            plugin.isAttackMode() ? "АКТИВЕН" : "Неактивен"
                        )
                            .color(
                                plugin.isAttackMode()
                                    ? NamedTextColor.RED
            ...
            .sendMessage(
                Component.text("Подключений/сек: ")
                    ...
                    .append(
                        Component.text(
                            String.valueOf(
                                plugin.getGlobalConnectionsPerSecond()
                            )
        ...
        invocation
            ...
            .sendMessage(
                Component.text("Онлайн игроков: ")
                    ...
                    .append(
                        Component.text(
                            String.valueOf(plugin.getServer().getPlayerCount())
                        ).color(NamedTextColor.GREEN)
                    )
            );
        ...
        invocation
            .source()
            .sendMessage(
                Component.text("══════ Активные модули ══════").color(
                    NamedTextColor.GOLD
                )
            );
        ...
        sendModuleStatus(
            invocation,
            "Проверка клиентов",
            config.isClientCheckEnabled()
        );
        sendModuleStatus(
            invocation,
            "VPN/Proxy детекция",
            config.isVpnCheckEnabled()
        );
        sendModuleStatus(
            invocation,
            "GeoIP блокировка",
            config.isGeoBlockEnabled()
        );
        sendModuleStatus(
            invocation,
            "Проверка никнеймов",
            config.isNameCheckEnabled()
        );
        sendModuleStatus(
            invocation,
            "Строгий режим",
        ...
        invocation
            ...
            .sendMessage(
                Component.text("  " + module + ": ")
                    ...
                    .append(
                        Component.text(enabled ? "ВКЛ" : "ВЫКЛ").color(
    ...
    private void sendStats(Invocation invocation) {
        ...
        invocation
            .source()
            .sendMessage(
                Component.text("══════ Статистика обнаружений ══════").color(
                    NamedTextColor.GOLD
                )
            );
    ...
    private void sendBlockedList(Invocation invocation) {
        ...
        if (blocked.isEmpty()) {
            invocation
                .source()
                .sendMessage(
                    Component.text("Нет заблокированных IP адресов.").color(
                        NamedTextColor.GREEN
                    )
                );
            return;
        ...
        invocation
            ...
            .sendMessage(
                Component.text(
                    "══════ Заблокированные IP (" + blocked.size() + ") ══════"
                ).color(NamedTextColor.GOLD)
            );
            ...
            invocation
                ...
                .sendMessage(
                    Component.text("  " + ip)
                        ...
                        .clickEvent(
                            ClickEvent.suggestCommand("/antibot unblock " + ip)
                        )
                );
        });
    }
    ...
    private void handleWhitelist(Invocation invocation, String[] args) {
        if (args.length < 4) {
            invocation
                ...
                .sendMessage(
                    Component.text(
                        "Использование: /antibot whitelist <add/remove> <ip/player> <value>"
                    ).color(NamedTextColor.RED)
                );
            return;
        }
        ...
        switch (action) {
            case "add":
                if (type.equals("ip")) {
                    ...
                    invocation
                        ...
                        .sendMessage(
                            Component.text(
                                "Игрок " + value + " добавлен в вайтлист!"
                            ).color(NamedTextColor.GREEN)
                        );
                }
                break;
            case "remove":
                if (type.equals("ip")) {
                    ...
                    invocation
                        ...
                        .sendMessage(
                            Component.text(
                                "Игрок " + value + " удален из вайтлиста!"
                            ).color(NamedTextColor.YELLOW)
                        );
                }
                break;
            default:
                invocation
                    .source()
                    .sendMessage(
                        Component.text("Неизвестное действие: " + action).color(
                            NamedTextColor.RED
                        )
                    );
        }
    ...
    private void sendBehaviorStats(Invocation invocation) {
        ...
        Map<String, BehaviorAnalyzer.PlayerBehavior> behaviors =
            analyzer.getAllBehaviors();
        ...
        behaviors
            ...
            .sorted((a, b) ->
                Integer.compare(
                    b.getSuspiciousActions(),
                    a.getSuspiciousActions()
                )
            )
            .limit(10)
            .forEach(behavior -> {
                NamedTextColor color =
                    behavior.getSuspiciousActions() > 5
                        ? NamedTextColor.RED
                        : behavior.getSuspiciousActions() > 2
                            ...
                            .append(
                                Component.text(
                                    " - подозрительных действий: " +
                                        behavior.getSuspiciousActions()
                                ).color(NamedTextColor.GRAY)
                            )
                            .clickEvent(
                                ClickEvent.runCommand(
                                    "/antibot behavior " +
                                        behavior.getPlayerName()
                                )
                            )
                    );
            });
            ...
            .ifPresentOrElse(
                player -> {
                    String ip = player
                        ...
                        .getAddress()
                        .getHostAddress();
                    BehaviorAnalyzer.PlayerBehavior behavior = plugin
                        .getBehaviorAnalyzer()
                        .getOrCreateBehavior(playerName, ip);
                    ...
                    invocation
                        .source()
                        .sendMessage(
                            Component.text("Всего подключений: ")
                                .color(NamedTextColor.WHITE)
                                .append(
                                    Component.text(
                                        String.valueOf(
                                            behavior.getTotalConnections()
                                        )
                                    ).color(NamedTextColor.YELLOW)
                                )
                        );
                    invocation
                        .source()
                        .sendMessage(
                            Component.text("Быстрых переподключений: ")
                                .color(NamedTextColor.WHITE)
                                .append(
                                    Component.text(
                                        String.valueOf(
                                            behavior.getFastReconnects()
                                        )
                                    ).color(NamedTextColor.GOLD)
                                )
                        );
                    invocation
                        .source()
                        .sendMessage(
                            Component.text("Подозрительных действий: ")
                                .color(NamedTextColor.WHITE)
                                .append(
                                    Component.text(
                                        String.valueOf(
                    ...
                    invocation
                        .source()
                        .sendMessage(
                            Component.text("Использованные ники: ")
                                .color(NamedTextColor.WHITE)
                                .append(
                                    Component.text(
                                        String.join(
                                            ", ",
                                            behavior.getUsedNames()
                                        )
                                    ).color(NamedTextColor.GRAY)
                                )
                        );
                    invocation
                        .source()
                        .sendMessage(
                            Component.text("Верифицирован: ")
                                .color(NamedTextColor.WHITE)
                                .append(
                                    Component.text(
                                        behavior.isVerified() ? "Да" : "Нет"
                                    ).color(
                                        behavior.isVerified()
                                            ? NamedTextColor.GREEN
                                            : NamedTextColor.RED
                ...
                () -> {
                    invocation
                        ...
                        .sendMessage(
                            Component.text(
                                "Игрок " + playerName + " не найден онлайн."
                            ).color(NamedTextColor.RED)
                        );
                }
            );
        ...
        plugin
            ...
            .ifPresentOrElse(
                player -> {
                    ...
                    if (clientBrand != null) {
                        var result = plugin
                            .getClientBrandDetector()
                            .analyze(clientBrand);
                        invocation
                            .source()
                            .sendMessage(
                                Component.text("Статус клиента: ")
                                    .color(NamedTextColor.WHITE)
                                    .append(
                                        Component.text(
                                            result.isDetected()
                    ...
                    invocation
                        .source()
                        .sendMessage(
                            Component.text("VPN/Proxy: ")
                                .color(NamedTextColor.WHITE)
                                .append(
                                    Component.text(
                                        vpnResult.isSuspicious()
                                            ? "Обнаружен"
                                            : "Не обнаружен"
                                    ).color(
                                        vpnResult.isSuspicious()
                    ...
                    invocation
                        .source()
                        .sendMessage(
                            Component.text("Провайдер: ")
                                .color(NamedTextColor.WHITE)
                                .append(
                                    Component.text(geoData.getIsp()).color(
                                        NamedTextColor.GRAY
                                    )
                                )
                        );
    ...
    public CompletableFuture<List<String>> suggestAsync(Invocation invocation) {
        ...
        if (args.length <= 1) {
            ...
            switch (args[0].toLowerCase()) {
                ...
                case "check":
                    ...
                    break;
                case "discord":
                    suggestions.addAll(List.of("status", "reload"));
                    break;
                case "linked":
                    suggestions.addAll(List.of("player", "discord"));
                    break;
            }
        } else if (args.length == 3 && args[0].equalsIgnoreCase("whitelist")) {
            suggestions.addAll(List.of("ip", "player"));
        } else if (args.length == 3 && args[0].equalsIgnoreCase("linked")) {
            suggestions.addAll(
                plugin
                    .getServer()
                    .getAllPlayers()
        ...
        String prefix =
            args.length > 0 ? args[args.length - 1].toLowerCase() : "";
    ...
    // Новые методы для Discord и привязки аккаунтов

    private void handleLinked(Invocation invocation, String[] args) {
        if (args.length < 3) {
            invocation
                .source()
                .sendMessage(
        ...
        if (type.equals("player")) {
                ...
                invocation
                    ...
                    .sendMessage(
                        Component.text("✅ Игрок ")
                            ...
                            .append(
                                Component.text(" привязан к Discord: ").color(
                                    NamedTextColor.GREEN
                                )
                            )
                            .append(
                                Component.text("<@" + discordId + ">").color(
                                    NamedTextColor.AQUA
                                )
                            )
                    );
                ...
                invocation
                    ...
                    .sendMessage(
                        Component.text("❌ Игрок ")
                            ...
                            .append(
                                Component.text(
                                    " не имеет привязки к Discord"
                                ).color(NamedTextColor.RED)
                            )
                    );
            }
        } else if (type.equals("discord")) {
            String nickname = plugin.getAccountLinkManager().getNickname(value);
            if (nickname != null) {
                invocation
                    .source()
                    .sendMessage(
                        Component.text("✅ Discord ")
                            ...
                            .append(
                                Component.text(" привязан к игроку: ").color(
                                    NamedTextColor.GREEN
                                )
                            )
                            .append(
                                Component.text(nickname).color(
                                    NamedTextColor.YELLOW
                                )
                            )
                    );
            ...
            invocation
                ...
                .sendMessage(
                    Component.text(
                        "Неизвестный тип! Используйте: player или discord"
                    ).color(NamedTextColor.RED)
                );
        }
    }

    private void handleDiscord(Invocation invocation, String[] args) {
        if (args.length < 2) {
            invocation
                .source()
                .sendMessage(
                    Component.text(
                        "Использование: /antibot discord <status/reload>"
                    ).color(NamedTextColor.RED)
                );
            return;
        }
        ...
        if (subcommand.equals("status")) {
            ...
            if (bot == null) {
                invocation
                    ...
                    .sendMessage(
                        Component.text(
                            "❌ Discord Bot не инициализирован"
                        ).color(NamedTextColor.RED)
                    );
                return;
            }
            ...
            invocation
                .source()
                .sendMessage(
                    Component.text("══════ Статус Discord Bot ══════").color(
                        NamedTextColor.GOLD
                    )
                );
            invocation
                .source()
                .sendMessage(
                    Component.text("Статус: ")
                        .color(NamedTextColor.WHITE)
                        .append(
                            Component.text(
                                bot.isEnabled() ? "✅ Активен" : "❌ Отключен"
                            ).color(
                                bot.isEnabled()
                                    ? NamedTextColor.GREEN
                                    : NamedTextColor.RED
                ...
                invocation
                    ...
                    .sendMessage(
                        Component.text("Бот: ")
                            ...
                            .append(
                                Component.text(
                                    bot.getJDA().getSelfUser().getAsTag()
                                ).color(NamedTextColor.AQUA)
                            )
                    );
                invocation
                    .source()
                    .sendMessage(
                        Component.text("Серверов: ")
                            .color(NamedTextColor.WHITE)
                            .append(
                                Component.text(
                                    String.valueOf(
                                        bot.getJDA().getGuildCache().size()
                                    )
                                ).color(NamedTextColor.YELLOW)
                            )
                    );
            ...
            invocation
                .source()
                .sendMessage(
                    Component.text("✅ Discord Bot перезагружен!").color(
                        NamedTextColor.GREEN
                    )
                );
        } else {
            invocation
                ...
                .sendMessage(
                    Component.text(
                        "Неизвестная команда! Используйте: status или reload"
                    ).color(NamedTextColor.RED)
                );
        }
    }

    private void sendAccountsStats(Invocation invocation) {
        int totalLinked = plugin
            .getAccountLinkManager()
        ...
        invocation
            .source()
            .sendMessage(
                Component.text("Всего привязано: ")
                    .color(NamedTextColor.WHITE)
                    .append(
                        Component.text(String.valueOf(totalLinked)).color(
                            NamedTextColor.AQUA
                        )
                    )
            );

        // Топ 10 привязанных аккаунтов
        Map<String, String> allLinks = plugin
            .getAccountLinkManager()
            .getAllLinks();
        if (!allLinks.isEmpty()) {
            invocation.source().sendMessage(Component.empty());
            invocation
                .source()
                .sendMessage(
                    Component.text("Привязанные аккаунты (до 10):").color(
                        NamedTextColor.GRAY
                    )
                );
                    ...
                    invocation
                        ...
                        .sendMessage(
                            Component.text("  • ")
                                .color(NamedTextColor.GRAY)
                                .append(
                                    Component.text(entry.getKey()).color(
                                        NamedTextColor.YELLOW
                                    )
                                )
                                .append(
